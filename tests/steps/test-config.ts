export const TEST_CONFIG = {
  ...
  SELECTORS: {
    ...
    PAGE_TITLE: 'h1',
    PAGE_DESCRIPTION: 'p',
    SERVICE_CARD: '[class*="service"], .service-card',
    PRICING_PLAN: '[class*="pricing"], [class*="plan"]',
    TESTIMONIAL: 'blockquote.testimonial, [class*="testimonial"], [class*="feedback"]',
    TESTIMONIAL_NAME: 'footer, [class*="name"], h4, h5',
    TESTIMONIAL_TEXT: 'q, p, [class*="text"], [class*="message"]',
    TESTIMONIAL_IMAGE: 'img, [class*="avatar"]',
    GALLERY_IMAGE: '[class*="gallery"] img, img[alt*="gallery"]',
