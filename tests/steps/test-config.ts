export const TEST_CONFIG = {
  ...
  SELECTORS: {
    ...
    PAGE_TITLE: 'h1',
    PAGE_DESCRIPTION: 'p',
    SERVICE_CARD: '.col-3, [class*="service"]',
    PRICING_PLAN: '.pricing-block, [class*="pricing"], [class*="plan"]',
    TESTIMONIAL: 'blockquote.testimonial, blockquote[class*="testimonial"]',
    TESTIMONIAL_NAME: 'footer',
    TESTIMONIAL_TEXT: 'q',
    TESTIMONIAL_IMAGE: 'img',
    FEATURE_BLOCK: '.icon-block, [class*="feature"]',
    GALLERY_IMAGE: '[class*="gallery"] img, img[class*="gallery"]',
